 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\TareaTipoRepository")
 */
...
class TareaTipo
{
     ...
     *
     * @param \AppBundle\Entity\Tarea $tareasTareaTipoRel
     *
     * @return TareaTipo
     */
    public function addTareasTareaTipoRel(\AppBundle\Entity\Tarea $tareasTareaTipoRel)
    {
     ...
     * @param \AppBundle\Entity\Tarea $tareasTareaTipoRel
     */
    public function removeTareasTareaTipoRel(\AppBundle\Entity\Tarea $tareasTareaTipoRel)
    {
