 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\NoContestanRepository")
 */
class NoContestan
{
     ...
     * Set noContestanRel
     *
     * @param \AppBundle\Entity\Llamada $noContestanRel
     *
     * @return NoContestan
     */
    public function setNoContestanRel(\AppBundle\Entity\Llamada $noContestanRel = null)
    {
