...
class Area
{
     ...
     * Add casosAreaRel.
     *
     * @param \AppBundle\Entity\Caso $casosAreaRel
     *
     * @return Area
     */
    public function addCasosAreaRel(\AppBundle\Entity\Caso $casosAreaRel)
    {
     ...
     */
    public function removeCasosAreaRel(\AppBundle\Entity\Caso $casosAreaRel)
    {
