 ...
 * @ORM\Entity(repositoryClass="AppBundle\Repository\CasoCategoriaRepository")
 */
class CasoCategoria
{
    /**
     ...
     *
     * @param \AppBundle\Entity\Caso $casosCategoriaRel
     *
     * @return CasoCategoria
     */
    public function addCasosCategoriaRel(\AppBundle\Entity\Caso $casosCategoriaRel)
    {
     ...
     * @param \AppBundle\Entity\Caso $casosCategoriaRel
     */
    public function removeCasosCategoriaRel(\AppBundle\Entity\Caso $casosCategoriaRel)
    {
