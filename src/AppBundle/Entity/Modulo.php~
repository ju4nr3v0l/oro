...
class Modulo
{
     ...
     *
     * @param \AppBundle\Entity\Llamada $llamadasModuloRel
     *
     * @return Modulo
     */
    public function addLlamadasModuloRel(\AppBundle\Entity\Llamada $llamadasModuloRel)
    {
     ...
     * @param \AppBundle\Entity\Llamada $llamadasModuloRel
     */
    public function removeLlamadasModuloRel(\AppBundle\Entity\Llamada $llamadasModuloRel)
    {
